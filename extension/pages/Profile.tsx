  ...
  return (
    <div className='h-full bg-gradient-to-b from-[#0f1a0f] via-black to-black mb-[35px] py-10'>
        <div className='flex flex-col justify-center !border-b-1 border-[#9DFFA1] px-5'>
            ...
            <p className='text-white text-center text-xl font-semibold my-3'>ethindian345</p>
            <p className='text-white text-center text-xl my-5'>Points: <span>7344</span></p>
        </div>
        <div className='border !boder-1 border-r-0 border-l-0 border-[#9DFFA1] py-2 px-5'>
            <div className='flex '>
                <p className='cursor-pointer text-[#9DFFA1] mr-5 font-semibold'>New</p>
